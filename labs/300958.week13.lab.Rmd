...
```{r}
tweet.count = nrow(tweet.text.matrix)
...
The probability $P(X = x_i\vert C = 1)$ is the probability of putting our
hand in the positive sentiment bag and pulling out the word $x_i$.
Therefore $P(X = x_i\vert C = 1)$ is given as:
$$
	P(X = x_i\vert C = 1) = \frac{\text{Frequency of $x_i$ in positive tweets}}{\text{Word count in positive tweets}}
$$
...
$$
	\text{sentiment weight}(x_i) = {\log{\left (\frac{P(X_i = x_i\vert C = 1)}{P(X_i = x_i\vert C = 0)}\right )}}
$$
