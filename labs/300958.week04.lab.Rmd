...
### Exercise
Use `read.csv` to read in the CSV files "keyMetrics.csv", "LifetimeLikesByGenderAge.csv" and "WeeklyReachDemog.csv" into data frames.
...
Try repeating the R analyses above for other columns in the keyMetrics.csv spreadsheet and using the
LifetimeLikesByGenderAge.csv (instead of WeeklyReach)
