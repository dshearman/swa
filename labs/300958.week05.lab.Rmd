...
to know about the Web proxy when within UWS. R may have already been
provided the proxy information, so first assume that the proxy has
been set.


## Installing twitteR and tm

If the proxy is set, you may install libraries using the install.packages command:
```{r eval=FALSE}
...
- [http://cran.r-project.org/web/packages/tm/index.html](http://cran.r-project.org/web/packages/tm/index.html)
- [http://cran.r-project.org/web/packages/twitteR/index.html](http://cran.r-project.org/web/packages/twitteR/index.html)
- [http://cran.r-project.org/web/packages/ROAuth/index.html](http://cran.r-project.org/web/packages/ROAuth/index.html)
...
```{.r}
twitter.dtm = DocumentTermMatrix(tweet.corpus) # create the DocumentTermMatrix object
twitter.matrix = inspect(twitter.dtm) # convert to a matrix
```
