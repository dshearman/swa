...
followers, then perform the following tasks using the chosen Twitter
handle.
...
b. cluster the tweets from the set of tweets using an appropriate
   number of clusters,

c. examine a sample of the tweets in each cluster to determine the
...
b. download the last 100 tweets of each friend,

c. examine if there is a significant difference in the words used
