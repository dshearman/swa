...
- The probability $p$ of word $w$ is the proportion of occurrences of
  word $w$ in the document collection.


## Binomial Example

A document collection contains 10 documents, each containing 100 words (total of 1000 words).

The word "the" appears 100 times in the collection, so its probability
is $p = 100/1000 = 0.1$

In a given document of length 100, "the" appears 12 times. The
probability of this occurring is:
$$
	P(X = 12) = \text{Binomial}(12, n = 100, p = 0.1) = 0.0987
$$

The word "tank" appears 3 times in the collection, so its probability
is $p = 3/1000 = 0.003$

In a given document of length 100, "tank" appears 2 times. The
probability of this occurring is:
$$
	P(X = 2) = \text{Binomial}(2, n = 100, p = 0.003) = 0.033
$$

The lower probability implies a less likely event. Since it has
happened, this event is special.
