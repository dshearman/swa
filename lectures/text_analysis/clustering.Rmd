...
Therefore, we can examine the SSW for clusterings with 2, 3, 4, \ldots
clusters, and choose the clustering with the smallest SSW.

\pause
Unfortunately, as we increase the number of clusters SSW will decrease.
...
minise the data loss, then use K-means on the projected data.
